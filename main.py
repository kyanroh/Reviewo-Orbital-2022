...
def main():
    ...
    # Command handlers for basic functions
    ...
    # Command handlers for model features
    ...
    dp.add_handler(CommandHandler("books", reviewo_bot.books))
    dp.add_handler(CommandHandler("electronics", reviewo_bot.electronics))
    dp.add_handler(CommandHandler("food", reviewo_bot.food))
